...
def parse_args():
    ...
    parser.add_argument('--pretrain', type=str, default='experiment/checkpoints/mode_pointnet2-0.922177-0148.pth',help='whether use pretrain model')
    parser.add_argument('--decay_rate', type=float, default=1e-4, help='decay rate of learning rate')
'experiment/checkpoi    nts/mode_pointnet2-0.922177-0148.pth'    parser.add_argument('--rotation',  default=None, help='range of training rotation')
