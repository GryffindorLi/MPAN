...
def parse_args():
    ...
    parser.add_argument('--pretrain', type=str, default='./experiment/pointnet2PartSeg-2019-09-20_14-21/checkpoints/pointnet2_164_0.9426.pth',help='whether use pretrain model')
...
def main(TEST_DATASET):
    ...
    testdataloader = torch.utils.data.DataLoader(TEST_DATASET, batch_size=args.batchsize,shuffle=False, num_workers=int(args.workers))
...
# 
        ...
        test_metrics, test_hist_acc, cat_mean_iou, part_pred = test_partseg(model.eval(), testdataloader, seg_label_to_cat,50,forpointnet2)
